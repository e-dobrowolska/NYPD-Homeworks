...
def co2_ranking(merged_data, start_year=0, end_year=2022):
    """
    ...
    if(start_year<=end_year):
        ...
        print(r"Error: Start Year can't be after End Year.")
        return


def gdp_ranking(merged_data, start_year=0, end_year=2022):
    """
